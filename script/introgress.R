...
box(lwd=2)
abline(v=2157.5, col="black", lwd=2)
abline(v=3627.5, col="black", lwd=2)
abline(v=5084.5, col="black", lwd=2)
abline(v=6190.5, col="black", lwd=2)
abline(v=6948.5, col="black", lwd=2)
abline(v=7261.5, col="black", lwd=2)
abline(v=7311.5, col="black", lwd=2)
axis(1, at=c(1079.5,2893,4356.5,5638,6570,7105.5,7287,8791), labels=c("1","2","3","4","5","6","*","unassigned scaffolds"), tick=FALSE, cex=0.5)
