...
plotQ(slist_K2[1],barbordersize=0.1,barbordercolour="black",returnplot=F,exportplot=T,basesize=11,width=15,grplab=onelabset,imgtype="jpeg",clustercol=c("#437570","#D5A034"),exportpath="~/Desktop")

#plot results with ordered samples for K=3
plotQ(slist_K3[1],barbordersize=0.1,barbordercolour="black",returnplot=F,exportplot=T,basesize=11,width=15,grplab=onelabset,grplabsize=1,imgtype="jpeg",clustercol=c("#D5A034","#749D58","#437570"),exportpath="~/Desktop")
